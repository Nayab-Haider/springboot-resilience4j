...
public class LibrarymanagementServiceImpl implements LibrarymanagementService {
    ...
    @Override
    @RateLimiter(name = "getBookwithRateLimit", fallbackMethod = "fallbackForRatelimitBook")
    ...
    public List<Book> fallbackForRatelimitBook(Throwable t) {
        logger.error("Inside fallbackForRatelimitBook, cause - {}", t.toString());
        return fallbackRetry(t);
    }
